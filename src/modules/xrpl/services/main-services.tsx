...
export const publicKey = naclUtil.decodeBase64(
  "01zkh+BamzzaVz5e1kpZflE4t1Dt8Ws/m9aywpX0PDA="
);
export const secretKey = naclUtil.decodeBase64(
  "hwbaEia+hrWBMUGlIHKY5YIvKgNprwnTCSn4hHtpD/4="
);
...
const hardcodedPublicKey =
  "3076301006072a8648ce3d020106052b8104002203620004ad04f6fa76bf8794a64ce1f21ace14a032ab0a154af562d59057b28287358e1f35e8e06dc26f21756e3611fd12128e04232e2e258d99b2bf9e963d8cf6bb8ad9a3d48f8c00b4ab103c16fbf20fce3df9d0da2983300bda3374f1b9de0ac208b9";

export async function encryptMessage(
  receivedPublicKeyRaw: string | null,
  message: string
) {
  receivedPublicKeyRaw = receivedPublicKeyRaw;
  const keyData = {
    crv: "P-384",
    ext: true,
    key_ops: ["deriveKey"],
    kty: "EC",
    x: "rQT2-na_h5SmTOHyGs4UoDKrChVK9WLVkFeygoc1jh816OBtwm8hdW42Ef0SEo4E",
    y: "Iy4uJY2Zsr-elj2M9ruK2aPUj4wAtKsQPBb78g_OPfnQ2imDMAvaM3Txud4Kwgi5",
  };

  // Import key
  let receivedPublicKey = await subtle.importKey("jwk", keyData, publicAlg, false, [
    "deriveKey",
  ]);
  // Generate key pair
